...
# 		      driver.implicitly_wait(10)
                          ...
                          #一旦try~exceptで様子見
                            ...
                            print("営業禁止ワードあり（計）：" + str(filter.keywords3))
                            print("その他の専用フォーム（計）：" + str(filter.keywords4))
                            print("その他の専用フォーム（計）：" + str(filter.keywords5))
...
# selectタグ内のid値が1個もない
                                    ...
                                    print("select_option：" +
                                          str(len(Select_contents.select_option)))
                                    print("option_value（optionタグ内のvalue値が0個以上）：" +
                                          str(len(Select_contents.option_value)))
                                    print("select_name_value（selectタグ内のname値が0個でない）：" +
                                          str(len(Select_contents.select_name_value)))
                                    print("select_id_value（selectタグ内のid値が1個もない）：" +
                                          str(len(Select_contents.select_id_value)))
...
# 文頭に個別の企業名を差し込めるよう仕様変更（2022.12.13）
                                ...
                                if "住所" in str(TEXTAREA.list_4tn) \
                                    ...
                                    if len([i for i in Get_tag_text.list_1 if "都道府県以降" in i
                                        ...
                                        driver.find_element_by_name(TEXTAREA.list_4tn[0]).send_keys(adid_4.m_comboBox6.GetValue()
                                                                                           + adid_4.m_textCtrl30.GetValue()
                                                                                           + adid_4.m_textCtrl31.GetValue()
                                                                                           + adid_4.m_textCtrl32.GetValue())
                                        input_history.append("住所")
                                        ...
                                        driver.find_element_by_name(
                                            TEXTAREA.list_4tn[0]).clear()
                                        driver.find_element_by_name(TEXTAREA.list_4tn[0]).send_keys(adid_4.m_textCtrl30.GetValue()
                                                                                           + adid_4.m_textCtrl31.GetValue()
                                                                                           + adid_4.m_textCtrl32.GetValue())
                                        input_history.append("住所")
