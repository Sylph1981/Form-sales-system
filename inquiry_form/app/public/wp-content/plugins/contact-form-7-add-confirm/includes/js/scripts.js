...
//プラグインのjsファイル"app\public\wp-content\plugins\Contact-Form-7-add-confirm\includes\js\scripts.js"を修正する必要があります。
	...
	if(jQuery(".wpcf7c-elm-step1").length != 0) {
		...
		jQuery(".wpcf7c-elm-step1").each(function(){
			...
			if(parent.attr("wpcf7c") == undefined) {
				...
				// parent.find(".wpcf7-back").addClass("wpcf7c-force-hide");
...
//【不具合１】Contact form 7 add confirmの確認ボタンを押しても動かない
//DOMのUnitTagを参照している方法が古いため、「event.detail.id」⇒「event.detail.unitTag」に変更
